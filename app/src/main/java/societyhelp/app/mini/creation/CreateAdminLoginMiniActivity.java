...
public class CreateAdminLoginMiniActivity extends DashBoardMiniActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_admin_login_id);
        ...
        progress = ProgressDialog.show(CreateAdminLoginMiniActivity.this, null, "Creating login in Database  ...", true, false);
