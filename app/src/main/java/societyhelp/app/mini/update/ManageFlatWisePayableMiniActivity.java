package societyhelp.app.mini.update;
...
import societyhelp.app.advance.FlatWiseAllPayableActivity;
...
public class ManageFlatWisePayableMiniActivity extends DashBoardActivity implements DatabaseConstant {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
                ...
                progress = ProgressDialog.show(ManageFlatWisePayableMiniActivity.this, null, "Generating Monthly Maintenance ...", true, false);
