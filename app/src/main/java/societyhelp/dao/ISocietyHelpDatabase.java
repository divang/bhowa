...
public interface ISocietyHelpDatabase {
     ...
     * @throws Exception
     */
    List<SocietyHelpTransaction> getUserWiseUnSplittedTransaction(String loginId) throws Exception;
     ...
     * @throws Exception
     */
    List<SocietyHelpTransaction> getFlatWiseUnSplittedTransaction(String flatId) throws Exception;
     ...
     * @throws Exception
     */
    List<SocietyDetails> getAllSociety() throws Exception;

    /**
     * Get all water suppliers
     */
    List<WaterSuppyReading> getAllWaterSupplier() throws Exception;
     ...
     * @throws Exception
     */
    void insertWaterReading(WaterSuppyReading reading) throws Exception;
     ...
     * @throws Exception
     */
    List<WaterSuppyReading> getAllWaterReading() throws Exception;

    /**
     * All credit transactions which are not mapped with any user.
     *
     * @return
     * @throws Exception
     */
    List<StagingTransaction> getUnsettledCreditTransaction() throws Exception;

    /**
     * All debit transactions which are not mapped with any user.
     *
     * @return
     * @throws Exception
     */
    List<StagingTransaction> getUnsettledDebitTransaction() throws Exception;


    /**
     * Settled credit transaction.
     *
     * @param transactions
     * @throws Exception
     */
    void settledCreditTransaction(Object transactions) throws  Exception;
}
