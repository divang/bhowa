...
# Dumping structure for table sql6135566.Expense_Type_Wise_Transactions
CREATE TABLE IF NOT EXISTS `Expense_Type_Wise_Transactions` (
...
# No rows in table sql6135566.Expense_Type_Wise_Transactions
