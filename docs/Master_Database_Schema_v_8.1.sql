...
INSERT IGNORE INTO `Transactions_BalanceSheet` (`Balance_Sheet_Transaction_ID`, `Amount`, `Verified_By_Admin`, `Verified_By_User`, `Expense_Type_Id`, `Transaction_From_Bank_Statement_ID`, `User_Cash_Payment_ID`, `Transaction_Expense_Id`) VALUES (1, 1000, '1', '1', 1, 1, NULL, NULL), (2, 2000, '1', '1', 1, 1, NULL, NULL), (3, 3000, '1', '1', 0, 1, NULL, NULL);
